...
class _GaleriaViewState extends State<GaleriaView> {
  ...
  Widget _buildGalleryGrid() {
    final List<Map<String, dynamic>> cuts = [
      {'name': 'Corte Clásico Hombre', 'description': 'Cortes de la escuela clásica para hombres', 'style': 'Clásico', 'price': '\$130 MXN', 'image': 'assets/images/corte_clasico.jpg'},
      {'name': 'Corte Buzz Mujer', 'description': 'Estilo moderno y atrevido para mujeres', 'style': 'Moderno', 'price': '\$170 MXN', 'image': 'assets/images/corte_buzz.jpg'},
      {'name': 'Barba Estilizada', 'description': 'Diseño, delineado y mantenimiento de barba', 'style': 'Barba', 'price': '\$80 MXN', 'image': 'assets/images/barba_estilizada.jpg'},
      {'name': 'Corte Pixie Mujer', 'description': 'Estilo corto y femenino con personalidad', 'style': 'Femenino', 'price': '\$170 MXN', 'image': 'assets/images/corte_pixie.jpg'},
      {'name': 'Corte Niño Pequeño', 'description': 'Pequeños con estilo, para cualquier evento', 'style': 'Infantil', 'price': '\$120 MXN', 'image': 'assets/images/corte_nino.jpg'},
      {'name': 'Corte Bob Mujer', 'description': 'Estilo clásico y versátil para mujeres', 'style': 'Clásico', 'price': '\$170 MXN', 'image': 'assets/images/corte_bob.jpg'},
      {'name': 'Cortes Degradado', 'description': 'Transición suave y moderna', 'style': 'Moderno', 'price': '\$130 MXN', 'image': 'assets/images/corte_degradado.jpg'},
      {'name': 'Corte Capas Mujer', 'description': 'Volumen y movimiento con estilo', 'style': 'Femenino', 'price': '\$170 MXN', 'image': 'assets/images/corte_capas.jpg'},
      {'name': 'Corte Web Mujer', 'description': 'Ondulado en la base', 'style': 'Tendencia', 'price': '\$170 MXN', 'image': 'assets/images/corte_web.jpg'},
      {'name': 'Diseño de Barba', 'description': 'Delineado y mantenimiento profesional', 'style': 'Barba', 'price': '\$80 MXN', 'image': 'assets/images/diseno_barba.jpg'},
      {'name': 'Corte Militar', 'description': 'Estilo estructurado y definido', 'style': 'Clásico', 'price': '\$130 MXN', 'image': 'assets/images/corte_militar.jpg'},
      {'name': 'Corte UnderCut', 'description': 'Estilo moderno con contraste', 'style': 'Moderno', 'price': '\$150 MXN', 'image': 'assets/images/corte_undercut.jpg'},
    ];
